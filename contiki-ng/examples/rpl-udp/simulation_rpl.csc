  ...
  <simulation>
    ...
    <radiomedium>
      org.contikios.cooja.radiomediums.UDGM
       <!-- Portée de transmission effective (en mètres) : au-delà, le message n'est pas reçu -->
      <transmitting_range>50.0</transmitting_range>

      <!-- Portée d'interférence en mètres : zone où un message peut brouiller une autre transmission -->
      <interference_range>100.0</interference_range> 

      <success_ratio_tx>1.0</success_ratio_tx> <!-- Taux de succès en émission-->
      <success_ratio_rx>1.0</success_ratio_rx>
    </radiomedium>

    <!-- Configuration des événements de simulation -->
    <events>
      <logoutput>40000</logoutput>
    </events>

    <!-- Premier type de mote : le SERVEUR UDP (nœud racine du réseau RPL / DAG root) -->
    <motetype>
      ...
      <!-- Second type de mote : les CLIENTS UDP (19 nœuds qui vont envoyer des données au serveur via RPL) -->
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
    ...
    <mote>
      ...
      <interface_config>
        ...
        <bitrate>250.0</bitrate> <!-- Débit radio simulé du mote, en kbps -->
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>mtype829</motetype_identifier> <!--mtype829 = firmware serveur-->
    </mote>

    <!--
      À partir d'ici : les 19 motes CLIENTS (id 2 à 20), tous basés sur mtype405 (udp-client.c).
      Chaque bloc <mote> suit exactement la même structure que le serveur ci-dessus :
        - Position (x, y, z)
        - ContikiMoteID (identifiant du nœud)
        - ContikiRadio (débit radio, 250 kbps)
        - ContikiEEPROM (mémoire vide)
        - motetype_identifier (mtype405)
      Seules la position et l'ID changent d'un mote à l'autre, formant une topologie multi-sauts
      autour du serveur (id 1) pour tester le routage RPL.
    -->
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
    ...
    <!-- Clients supplémentaires dans la même zone géographique -->
